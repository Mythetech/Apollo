...
namespace Apollo.Components.Settings;
 ...
 public partial class SettingsNavLink : MudComponentBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <see cref="Microsoft.AspNetCore.Components.Routing.NavLinkMatch.Prefix"/>.  This link is compared against the current URL to determine whether it is highlighted.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.NavMenu.Behavior)]
        ...
        /// <summary>
        /// The CSS applied to the inner link.
        /// </summary>
        [Parameter]
        [Category(CategoryTypes.ComponentBase.Common)]
